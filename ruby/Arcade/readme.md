...
|:---:|---|---|---|:---:|:---:|
| 1 | add | Write a function that returns the sum of two numbers. | [add.rb](./Intro-01-add) | 1 | :heavy_check_mark: |
| 2 | centuryFromYear | Given a year, return the century it is in. The first century spans from the year 1 up to and including the year 100, the second - from the year 101 up to and including the year 200, etc. | [centuryFromYear.rb](./Intro-02-centuryFromYear) | 3 | :heavy_check_mark: |
